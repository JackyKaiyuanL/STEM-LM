"""
Regenerate neus_nefsc_splits.json from the CSV using an h3 spatial-block fold
(train/val/test 0.8/0.1/0.1).

Resolution 4, not 2: the domain is 18.1 x 16.0 degrees, so res 2 puts the data
in ~15 cells with one holding a third of it.

Usage:
  python regen_splits.py \\
      --in_csv   ${REPO_ROOT}/data/neus_nefsc.csv \\
      --out_json ${REPO_ROOT}/data/neus_nefsc_splits_seed42.json \\
      --resolution 4 --seed 42

Self-contained — no model code needed. Mirrors STEMLM_data.py:h3_block_split.
"""
